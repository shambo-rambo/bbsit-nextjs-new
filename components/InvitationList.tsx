...
export default function InvitationList({ invitations, userId }: InvitationListProps) {
  ...
  return (
    <div className="bg-black text-white py-8 px-4 sm:px-10 sm:max-w-md mx-auto">
          ...
          <li key={invitation.id} className="bg-gray-900 p-4 rounded-lg shadow-md border border-gray-700">
            ...
            <div className="flex space-x-4">
              ...
              <button 
                ...
                className="flex-1 bg-gray-800 text-gray-300 font-bold py-2 px-4 rounded transition duration-300 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-600 focus:ring-opacity-50"
              >
                Decline
              </button>
            </div>
